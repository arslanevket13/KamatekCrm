        ...
        : IRequestHandler<GetDashboardStatsQuery, DashboardStatsDto>
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            var stats = new DashboardStatsDto
            {
                ...
                PendingTasks = tasks.Count(t => t.Status == JobStatus.Pending), // Fixed: use JobStatus.Pending
                ...
                CompletedToday = tasks.Count(t => 
                    ...
                    t.ModifiedDate?.Date == today), // Fixed: use ModifiedDate
        ...
        private double CalculateAverageCompletionTime(List<ServiceJob> tasks)
        {
            var completedTasks = tasks
                .Where(t => t.Status == JobStatus.Completed && 
                           ...
                           t.ModifiedDate != null) // Fixed: use CreatedDate/ModifiedDate
                .ToList();
