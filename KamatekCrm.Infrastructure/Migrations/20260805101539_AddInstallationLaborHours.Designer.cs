...
namespace KamatekCrm.Infrastructure.Migrations
{
    ...
    [Migration("20260805101539_AddInstallationLaborHours")]
    partial class AddInstallationLaborHours
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KamatekCrm.Shared.Models.CustomerInteraction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("InteractionNumber")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
                    ...
                    b.Property<bool>("RequiresManagerAttention")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("KamatekCrm.Shared.Models.CustomerInteractionHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("NewAssignedToUsername")
                        .HasMaxLength(150)
                        .HasColumnType("character varying(150)");
                    ...
                    b.ToTable("CustomerInteractionHistories");
                });
            ...
            modelBuilder.Entity("KamatekCrm.Shared.Models.QuoteLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("KamatekCrm.Shared.Models.ServiceJob", b =>
                {
                    ...
                    b.Property<string>("DiscoveryTechnicalNotes")
                        .HasColumnType("text");
                    ...
                    b.Property<bool>("IsConvertedToQuote")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("KamatekCrm.Shared.Models.WorkOrders.DiscoveryMaterial", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("DiscoveryReportId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("DiscoveryReportId");

                    b.HasIndex("ProductId");

                    b.ToTable("DiscoveryMaterials");
                });

            modelBuilder.Entity("KamatekCrm.Shared.Models.WorkOrders.DiscoveryReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("DiscoveryReports");
                });

            modelBuilder.Entity("KamatekCrm.Shared.Models.WorkOrders.DiscoveryVisit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("DiscoveryVisits");
                });

            modelBuilder.Entity("KamatekCrm.Shared.Models.WorkOrders.InstallationMaterial", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("InstallationMaterials");
                });

            modelBuilder.Entity("KamatekCrm.Shared.Models.WorkOrders.InstallationOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("CompletionTechnician")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
            ...
            modelBuilder.Entity("KamatekCrm.Shared.Models.WorkOrders.InstallationTask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("KamatekCrm.Shared.Models.WorkOrders.WorkOrderQuotation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("KamatekCrm.Shared.Models.CustomerInteraction", b =>
                {
                    b.HasOne("KamatekCrm.Shared.Models.User", "AssignedToUser")
                        .WithMany()
            ...
            modelBuilder.Entity("KamatekCrm.Shared.Models.CustomerInteractionHistory", b =>
                {
                    b.HasOne("KamatekCrm.Shared.Models.CustomerInteraction", "CustomerInteraction")
                        .WithMany("Histories")
            ...
            modelBuilder.Entity("KamatekCrm.Shared.Models.QuoteLine", b =>
                {
                    ...
                    b.HasOne("KamatekCrm.Shared.Models.Quote", "Quote")
                        .WithMany("Lines")
            ...
            modelBuilder.Entity("KamatekCrm.Shared.Models.WorkOrders.DiscoveryMaterial", b =>
                {
                    b.HasOne("KamatekCrm.Shared.Models.WorkOrders.DiscoveryReport", "DiscoveryReport")
                        .WithMany("Materials")
                        .HasForeignKey("DiscoveryReportId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("DiscoveryReport");
                });
            ...
            modelBuilder.Entity("KamatekCrm.Shared.Models.WorkOrders.InstallationMaterial", b =>
                {
                    b.HasOne("KamatekCrm.Shared.Models.WorkOrders.InstallationOrder", "InstallationOrder")
                        .WithMany("Materials")
                        .HasForeignKey("InstallationOrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("KamatekCrm.Shared.Models.WorkOrders.InstallationOrder", b =>
                {
                    b.HasOne("KamatekCrm.Shared.Models.WorkOrders.WorkOrderQuotation", "Quotation")
                        .WithMany()
